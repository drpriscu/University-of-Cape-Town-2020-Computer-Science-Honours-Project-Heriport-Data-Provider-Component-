#!/usr/bin/env python3
"""
MetsemegologoloOAIInterface.py: Program that acts as an OAI-PMH interface for The Metsemegologolo Archive Data Provider,
...
# Set server URL.
serverURL = "http://Metsemegologolo.apc.uct.ac.za/metadata/Metsemegologolo/"
...
try:
    ...
    # Else if query is a Identify request.  
        ...
        # Else generate XML response.
            ...
            # Set repositoryName.
            repositoryName = "The Metsemegologolo Archive"
        ...
        try:
            ...
            if (resumptionTokenFlag):
                ...
                if (resumptionTokenSetFlag):
                    if (resumptionTokenSet != "Metsemegologolo"):
                        # Raise badResumptionToken error.
                        raise
