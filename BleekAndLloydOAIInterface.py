#!/usr/bin/env python3
"""
BleekAndLloydOAIInterface.py: Program that acts as an OAI-PMH interface for The New Digital Bleek and Lloyd Archive Data Provider,
...
try:
    ...
    # Else if query is a Identify request.  
        ...
        # Else generate XML response.
            ...
            # Set repositoryName.
            repositoryName = "The New Digital Bleek and Lloyd Archive"
    ...
    # Else if query is a ListSets request.                
        ...
        # Else generate XML response.
            ...
            data += "\n          <dc:description>This set contains metadata describing stories from The New Digital Bleek and Lloyd Archive.</dc:description>"
            data += "\n       </oai_dc:dc>\n    </setDescription>\n  </set>"
